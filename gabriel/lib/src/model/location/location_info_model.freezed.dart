...
abstract class $LocationInfoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, AddressModel address});
...
/// @nodoc
@JsonSerializable()
class _$_LocationInfoModel
    with DiagnosticableTreeMixin
    implements _LocationInfoModel {
  const _$_LocationInfoModel(
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LocationInfoModel(id: $id, name: $name, address: $address)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'LocationInfoModel'))
...
abstract class _LocationInfoModel implements LocationInfoModel {
  const factory _LocationInfoModel(
      ...
      required final AddressModel address}) = _$_LocationInfoModel;
